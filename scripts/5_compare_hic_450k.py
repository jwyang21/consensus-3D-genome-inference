...
if __name__ == '__main__':
    ...
    suptitle_ = f'Histograms of binned corrmats (chr{args.chrom}_{args.cpg_type})'
    ...
    suptitle_ = f'PC1 (chr{args.chrom}_{args.cpg_type})'
    plt.suptitle(suptitle_ , fontsize = 15)
    plt.tight_layout()
    #plt.show()
    ...
    title_ = f'Scatter of PC1 (chr{args.chrom}, {args.cpg_type}, thresholded)'
    ...
    suptitle_ = f'Thresholded PC1 (chr{args.chrom}_{args.cpg_type})'
    plt.suptitle(suptitle_, fontsize = 15)
    plt.tight_layout()
    #plt.show()
